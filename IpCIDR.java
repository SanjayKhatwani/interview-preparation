...
public class RangeToCidr {
    public static List<String> range2cidrlist( String startIp, String endIp ) {
        ...
        while (start <= end) {
            ...
            // why max?.鏈枃鍘熷垱鑷�1point3acres璁哄潧
            // if the maxDiff is larger than maxMask. 鐗涗汉浜戦泦,涓€浜╀笁鍒嗗湴
            ...
            // So the next round start must add that number. more info on 1point3acres.com
